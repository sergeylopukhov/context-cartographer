...
- an existing `AGENTS.md` needs heavy rewriting;
...
- `AGENTS.md`, `README*`, `docs/architecture.md`, and profile docs conflict; mark `TODO: clarify` or ask instead of choosing a source of truth silently;
