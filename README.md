...
- A private offline documentation map with an Obsidian-style force layout, pan, zoom, draggable nodes, and focused connections.
...
- Приватная офлайн-карта документации в духе Obsidian: force-раскладка по областям, панорамирование, масштабирование, перетаскивание узлов и связи выбранного узла.
